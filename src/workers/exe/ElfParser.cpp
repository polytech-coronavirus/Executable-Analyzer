...
Elf64Parser::Elf64Parser(std::string inputFile) :
  ExeParser(inputFile)
{
  std::ifstream file(inputFile, std::ios::in | std::ios::binary);
  if (!file.is_open())
...
std::string Elf64Parser::getCreationTime()
{
  return "";
}

std::string Elf64Parser::getLastChangeTime()
{
  return "";
}

std::string Elf64Parser::getCompilationTime()
{
  return "";
}

std::string Elf64Parser::getFileSize()
{
  return "";
}

std::string Elf64Parser::getDigitalSignature()
{
  return "";
}

std::string Elf64Parser::getAlternateData()
{
  return "";
}

std::string Elf64Parser::getBitness()
{
  return "";
}

std::string Elf64Parser::getFileType()
{
  return "UNIX ELF64";
}
